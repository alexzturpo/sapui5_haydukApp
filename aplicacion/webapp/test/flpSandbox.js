		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Hayduk",
									"targetURL": "#apphaplicacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apphaplicacion-display": {
								"semanticObject": "apphaplicacion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apph.aplicacion",
									"url": sap.ui.require.toUrl("apph/aplicacion")
								}
							}
						}
					}
